    ...
    return (
        <SafeAreaView style={{ backgroundColor: clr.background }} className={`flex-1 px-5 pt-4`}>
            <View className="flex-row items-center justify-between">
                ...
                {leftIcon == "close" &&
                    <TouchableOpacity onPress={() => props.closeFunction} className={iconWidth}>
                        <IconButton
                            icon={getIcon(leftIcon)}
                            iconColor={clr.primary}
                            size={32}
                ...
                {leftIcon == "friends" &&
                    <TouchableOpacity onPress={() => router.push("/friends")} className={iconWidth}>
                        <IconButton
                            icon={getIcon(leftIcon)}
                            iconColor={clr.primary}
                            size={32}
                ...
                {rightIcon == "profile" &&
                    <TouchableOpacity onPress={() => router.push("/profile")} className={iconWidth}>
                        <IconButton
